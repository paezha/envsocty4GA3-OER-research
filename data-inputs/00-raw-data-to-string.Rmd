...
1. Extract the files from the zip folders.
2. Rename the files.
3. Extract the mini-reflection from the exercises.
4. Join all text in individual, anonymized files for sharing with analysts.
